...
<strong>Funding Agency:</strong> Software Center

<strong>Principle Investigators:</strong> Gregory Gay, Eduard Enoiu (Mälardalen University)

<strong>Involved Lab Members:</strong> Gregory Gay, Francisco Gomes de Oliveira Neto

<strong>Other Researchers:</strong> Eduard Enoiu, Jean Malm (Mälardalen University)
...
<strong>Publications:</strong> {% cite 10.1145/3691620.3695273 %} 

<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/proj3.png" title="Project Overview" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Project Overview
...
<ul>
<li>LLM-enabled fault localization.</li>
<li>Generation of human-like test cases using AI/ML techniques.</li>
<li>Exploration of synergies between human and automated test creation.</li>
<li>Investigation of cognitive and human factors to improve test automation.</li>
<li>Integration of automated testing tools into the developer workflow.</li>
<li>Investigation of trust challenges in test automation.</li>
<li>Integration of visualization and data analysis techniques to support testing.</li>
</ul>
